...
public class EntertainmentFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.entertainRecyclerView);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController.navigate(R.id.action_entertainmentFragment_to_newsFeedFragment);
            }
        });
    }
    ...
    private void loadRetrofit(){
        ...
        Call<ResponseModel> call = apiService.getLatestNews("za","entertainment",API_KEY);
